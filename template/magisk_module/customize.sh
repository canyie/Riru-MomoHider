...
if [ ! -f "$DATA_DIR/isolated" ]; then
  touch "$DATA_DIR/.isolated"
fi

if [ ! -f "$DATA_DIR/setns" ]; then
  touch "$DATA_DIR/.setns"
fi

if [ ! -f "$DATA_DIR/app_zygote_magic" ]; then
  touch "$DATA_DIR/.app_zygote_magic"
fi

if [ ! -f "$DATA_DIR/initrc" ]; then
  touch "$DATA_DIR/.initrc"
fi
